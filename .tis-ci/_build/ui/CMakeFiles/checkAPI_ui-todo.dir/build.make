...
ui/CMakeFiles/checkAPI_ui-todo:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/fabien/work/tmp/selfcontained_wireshark/wireshark/.tis-ci/_build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running checkAPI_ui-todo"
	cd /home/fabien/work/tmp/selfcontained_wireshark/wireshark/ui && /usr/bin/perl /home/fabien/work/tmp/selfcontained_wireshark/wireshark/tools/checkAPIs.pl -M alert_box.c capture.c capture_ui_utils.c clopts_common.c cmdarg_err.c commandline.c console.c decode_as_utils.c dissect_opts.c export_object_ui.c export_pdu_ui_utils.c help_url.c failure_message.c file_dialog.c filter_files.c firewall_rules.c iface_toolbar.c iface_lists.c io_graph_item.c language.c mcast_stream.c packet_list_utils.c packet_range.c persfilepath_opt.c preference_utils.c profile.c proto_hier_stats.c recent.c rtp_media.c rtp_stream.c rtp_stream_id.c service_response_time.c software_update.c ssl_key_export.c summary.c tap_export_pdu.c tap-iax2-analysis.c tap-rtp-analysis.c tap-rtp-common.c tap-sctp-analysis.c tap-rlc-graph.c tap-tcp-stream.c text_import.c time_shift.c traffic_table_ui.c util.c voip_calls.c
...
ui/CMakeFiles/checkAPI_ui-todo.dir/clean:
	cd /home/fabien/work/tmp/selfcontained_wireshark/wireshark/.tis-ci/_build/ui && $(CMAKE_COMMAND) -P CMakeFiles/checkAPI_ui-todo.dir/cmake_clean.cmake
.PHONY : ui/CMakeFiles/checkAPI_ui-todo.dir/clean

ui/CMakeFiles/checkAPI_ui-todo.dir/depend:
	cd /home/fabien/work/tmp/selfcontained_wireshark/wireshark/.tis-ci/_build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/fabien/work/tmp/selfcontained_wireshark/wireshark /home/fabien/work/tmp/selfcontained_wireshark/wireshark/ui /home/fabien/work/tmp/selfcontained_wireshark/wireshark/.tis-ci/_build /home/fabien/work/tmp/selfcontained_wireshark/wireshark/.tis-ci/_build/ui /home/fabien/work/tmp/selfcontained_wireshark/wireshark/.tis-ci/_build/ui/CMakeFiles/checkAPI_ui-todo.dir/DependInfo.cmake --color=$(COLOR)
